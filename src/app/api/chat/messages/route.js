...
//         // SIMPLIFIED QUERY - removed JSON functions
...
//         // Mark messages as read (keep this part)
//         await pool.query(`
...
//         return NextResponse.json(
//             { error: error.message }, // Shows actual error
//             { status: 500 }
//         );
//     }
// }
...
//         // Check if user is authorized to send message in this room
